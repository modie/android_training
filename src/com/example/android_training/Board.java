...
public class Board {
	/*
	 * <bstrds> dld to color einai -1 gia mavro, 1 gia aspro
		<modie> http://ammar.gr/myloader/vfile.php?i=0cdb32d43a8c4bba18257298341ffe88-Screenshot3.png
		<bstrds> kai ama einai 0 simainei pos i 8esh einai empty
	 * 
	 * 
	 * */
	...
	public Board() {
		...
		positions[2].setCol(W);
		positions[2].setNum((byte)7);
		...
		//added something for presentation purposes 
		positions[9].setCol(W);
		positions[9].setNum((byte)8);
		positions[14].setCol(W);
		positions[14].setNum((byte)6);
		positions[21].setCol(W);
		positions[21].setNum((byte)9);
		//end of my add
